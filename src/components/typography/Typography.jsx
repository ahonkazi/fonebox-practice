...
export const SectionTitleCentered = ({ subTitle = 'Sub title here', title = 'Title Here', nextLine = null, responsive = false, mdTitle = '', mdNextLine = '' }) => {
    return (
        <div className="section-title flex flex-col items-center lg:block text-center  w-full font-Inter lg:w-fit">
            <p className='text-Blue xl:text-lg 2xl:text-xl font-medium leading-[160%] '>{subTitle}</p>
            <div className="lg:mt-2 2xl:mt-3 w-fit relative">
