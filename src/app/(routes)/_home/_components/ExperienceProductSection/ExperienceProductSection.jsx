...
import exp3 from "../../_assets/experience3.png";
import exp4 from "../../_assets/experience4.png";
    ...
    <div className="experience-section site-container mt-section ">
      ...
      <div className="flex justify-between mt-10 relative p-5">
        <div className="w-[65%] relative">
          <Image
            className="h-full rounded-2xl w-full object-center"
            src={exp2}
            alt="experience2-img"
          />
          <div className=" absolute  top-[20%] -right-[15%] border-10 border-white rounded-full flex justify-center items-center">
            <Image
            ...
            />
            <Image
              className="absolute  h-[30%]  object-center"
              src={exp4}
              alt="experience2-img"
            />
          </div>
        ...
        <div className="mx-10 ">
          <div className="w-56 mb-10 ">
            <p className="text-[18px] xs:text-[20px] 2xl:text-[22px] font-medium font-Inter leading-[120%]">
              Future Technology
            </p>
            <p className="text-Gray 2xl:text-[18px] text-sm xs:text-base my-1.5 font-Inter leading-[160%] ">
