...
export const ThemeContext = ({ children }) => {
    ...
    return (
        <GetThemeContext.Provider value={{ sidebarStatus, setSidebarStatus, menuItems, deshtopSearchBarStatus, setdeshtopSearchBarStatus }}>{children}</GetThemeContext.Provider>
    )
}